...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($check_stmt) {
      ...
      $service_type_name = $selected_name;
  } else {
      $selected_name = '';
  }
  ...
  if ($dup_stmt) {
    ...
    try {
        ...
        $sql = "INSERT INTO appointments (user_id, appointment_date, appointment_time, comment, service_type, status, created_at) 
        ...
        $stmt->bind_param("issss", $user_id, $date, $time, $comment, $service_type_name);
